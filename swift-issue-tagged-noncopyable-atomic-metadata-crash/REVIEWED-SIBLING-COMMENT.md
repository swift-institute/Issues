...
- Investigation arc: [`INVESTIGATION-ARC.md`](INVESTIGATION-ARC.md); workspace handoffs an internal handoff document (Arcs 1–3) + an internal handoff document (Arcs 4–5).
