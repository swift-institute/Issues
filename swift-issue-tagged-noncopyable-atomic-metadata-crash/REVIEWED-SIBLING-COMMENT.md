...
- Investigation arc: [`INVESTIGATION-ARC.md`](INVESTIGATION-ARC.md); workspace handoffs `HANDOFF-test-sigsegv-post-cycle-break.md` (Arcs 1–3) + `HANDOFF-tagged-noncopyable-atomic-metadata-crash.md` (Arcs 4–5).
