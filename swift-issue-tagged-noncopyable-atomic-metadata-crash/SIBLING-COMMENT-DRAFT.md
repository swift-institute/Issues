...
- Investigation arcs: [`INVESTIGATION-ARC.md`](INVESTIGATION-ARC.md) (4-arc history through bare-`swiftc` reduction + v1 retry); workspace handoffs `HANDOFF-test-sigsegv-post-cycle-break.md` (Arcs 1–3) + `HANDOFF-tagged-noncopyable-atomic-metadata-crash.md` (Arcs 4–5)
