...
@Suite
struct InlinerEscapingCarrierBitwiseUnderlyingReproducer {
    ...
    static func bugFires() -> Bool? {
        ...
        let swiftCopy = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("inliner-escaping-carrier-bitwise-test-\(pid).swift")
        let out = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("inliner-escaping-carrier-bitwise-test-\(pid).o")
