...
(`HANDOFF-sparse-occupancy-placement.md` — leaf-owned occupancy probe). The release-broken
...
placement" decision (`~/Developer/.handoffs/HANDOFF-sparse-occupancy-placement.md`): a
